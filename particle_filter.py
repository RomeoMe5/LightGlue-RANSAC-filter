...
Original file is located at
    https://colab.research.google.com/drive/1tRE_SKeKZJY38OkVohq7sP9H25lUFyhF
"""
...
every_third_coordinate = every_fifth_coordinate[:30]
print(every_fifth_coordinate)
print(angles)

print(final_coords)

distances = np.linalg.norm(np.array(final_coords) - np.array(every_fifth_coordinate), axis=1)
print(distances)
